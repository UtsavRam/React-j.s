  ...
  return (
    ...
    <div className="container ">
      <div className="row p-3  ">
       <div className="col-10 col-md-3 col-lg-4 d-flex align-items-center">
        <h3 className='ps-4 ps-sm-5 ms-5'>
            Booking.com
        </h3>
        <div className="col d-block d-md-none d-flex aling-items-center justify-content-end ms-3">
           <Bar/>
           </div>
       </div>
        <div className="col-2 col-md-9 col-lg-8 d-flex align-items-center justify-content-end">
        <div className='d-none d-md-block'>
        <ul className="nav">
        <li className="nav-item">
        <a className="text-decoration-none text-white fs-3 ms-5" href="#">
            INR
        </a>
        </li>
        <li className="nav-item ms-2">
        <a className="nav-link text-white" href="#">
     <div className="flag rounded rounded-circle overflow-hidden ms-2">  
     <img src={data} alt="" className='' width={"30px"} height={"30px"} />
     </div>
        </a>
        </li>
        </ul>
         ...
         <span className='ms-3'>
         <svg xmlns="http://www.w3.org/2000/svg" fill='white' width={"25px"} height={"25px"} viewBox="0 0 24 24"><path d="M9.75 9a2.25 2.25 0 1 1 3 2.122 2.25 2.25 0 0 0-1.5 2.122v1.006a.75.75 0 0 0 1.5 0v-1.006c0-.318.2-.602.5-.708A3.75 3.75 0 1 0 8.25 9a.75.75 0 1 0 1.5 0zM12 16.5a1.125 1.125 0 1 0 0 2.25 1.125 1.125 0 0 0 0-2.25.75.75 0 0 0 0 1.5.375.375 0 1 1 0-.75.375.375 0 0 1 0 .75.75.75 0 0 0 0-1.5zM22.5 12c0 5.799-4.701 10.5-10.5 10.5S1.5 17.799 1.5 12 6.201 1.5 12 1.5 22.5 6.201 22.5 12zm1.5 0c0-6.627-5.373-12-12-12S0 5.373 0 12s5.373 12 12 12 12-5.373 12-12z"></path></svg>
         </span>
        </a>

        <button className='ms-4 px-3 py-2 ms-3 bg-transparent  border-0 text-white Btn'>
            List Your Property
        </button>

        <button className='btn btn-light" border-0 bg-light text-primary ms-3 '>Register</button>
        <button className='btn btn-light" border-0 bg-light text-primary ms-4  '>Sing in</button>
         </div>
          </div>  
       </div>
      ...
      <Link to='/'>
      <button className='bg-transparent px-3 py-2 border-white border-2 border me-2 rounded-1 text-white rounded-4 Btn'>
        <span className='px-3'>
        <svg xmlns="http://www.w3.org/2000/svg" fill='white' height={"25px"} width={"25px"} viewBox="0 0 24 24"><path d="M2.75 12h18.5c.69 0 1.25.56 1.25 1.25V18l.75-.75H.75l.75.75v-4.75c0-.69.56-1.25 1.25-1.25zm0-1.5A2.75 2.75 0 0 0 0 13.25V18c0 .414.336.75.75.75h22.5A.75.75 0 0 0 24 18v-4.75a2.75 2.75 0 0 0-2.75-2.75H2.75zM0 18v3a.75.75 0 0 0 1.5 0v-3A.75.75 0 0 0 0 18zm22.5 0v3a.75.75 0 0 0 1.5 0v-3a.75.75 0 0 0-1.5 0zm-.75-6.75V4.5a2.25 2.25 0 0 0-2.25-2.25h-15A2.25 2.25 0 0 0 2.25 4.5v6.75a.75.75 0 0 0 1.5 0V4.5a.75.75 0 0 1 .75-.75h15a.75.75 0 0 1 .75.75v6.75a.75.75 0 0 0 1.5 0zm-13.25-3h7a.25.25 0 0 1 .25.25v2.75l.75-.75h-9l.75.75V8.5a.25.25 0 0 1 .25-.25zm0-1.5A1.75 1.75 0 0 0 6.75 8.5v2.75c0 .414.336.75.75.75h9a.75.75 0 0 0 .75-.75V8.5a1.75 1.75 0 0 0-1.75-1.75h-7z"></path></svg>
       </span>
        <span>Home</span>
